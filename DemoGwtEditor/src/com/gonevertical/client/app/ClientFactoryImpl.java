...
public class ClientFactoryImpl implements ClientFactory {
   ...
   *  
   *  these are located in this, ClientFactory, ApplicationActivityMapper
   */
  public HomePlace.Tokenizer getHomePlaceTokenizer() {
    return new HomePlace.Tokenizer(requestFactory);
  }

  public PeopleListPlace.Tokenizer getPeopleListTokenizer() {
    return new PeopleListPlace.Tokenizer(requestFactory);
  }

  public PeopleEditPlace.Tokenizer getPeopleEditTokenizer() {
    return new PeopleEditPlace.Tokenizer(requestFactory);
  }
}
